    ...
    <section id="research" className="py-0 bg-background">
      <div className="container-custom">
        ...
        >
          <div className="text-left">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              My academic contributions to the fields of machine learning,
              computer vision, IoT and artificial intelligence.
            </p>
          </div>
        </motion.div>
              ...
              <Card className="overflow-hidden border-opacity-40 relative">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <p
                      className={`text-gray-600 dark:text-gray-300 ${expandedId === paper.id ? "" : "line-clamp-3"}`}
                    >
                      {paper.abstract}
                    </p>
        ...
        <motion.div
          ...
          className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm mt-10 border border-gray-100 dark:border-gray-700"
        >
          <div className="flex flex-col md:flex-row gap-6 items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 mt-1">
                I'm always open to new collaborative research opportunities in
                ML, computer vision, and AI.
              </p>
            </div>
