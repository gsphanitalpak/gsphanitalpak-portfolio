...
export default function HeroSection() {
  ...
  return (
    <section
      id="home"
      ref={containerRef}
      className="min-h-screen flex flex-col justify-between px-4 relative overflow-hidden bg-background text-foreground transition-colors duration-300"
    >
      <div className="container-custom relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full max-w-7xl mx-auto">
        ...
        <div className="space-y-8 text-center lg:text-left">
          ...
          >
            Applied AI Engineer | Robotics Developer | Researcher
          </motion.div>
          ...
          >
            ...
            <span className="font-mono font-extrabold">Gandhala</span>
          </motion.h1>
          ...
          <motion.h3
            ...
            animate="visible"
            variants={fadeInUpVariants}
            className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-extralight font-mono tracking-tight leading-tight text-left"
          >
            Transforming <br />
            ...
            <br />
            into intelligent systems, real-world prototypes, and applied AI
            solutions.
          </motion.h3>
        ...
        {/* AVATAR */}
        <motion.div
          className="flex justify-around items-center px-0 py-0"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          ...
          >
            ...
            >
              <div className="absolute inset-0">
                ...
                >
                  <FaCode className="bg-primary text-white dark:text-gray-900 rounded-xl h-8 w-8 sm:h-10 sm:w-10 p-2" />
                </motion.div>
                ...
                <motion.div
                  ...
                  transition={{ repeat: Infinity, duration: 6, ease: "linear" }}
                >
                  <FaRobot className="border-2 border-primary bg-transparent text-primary rounded-xl h-8 w-8 sm:h-10 sm:w-10 p-2" />
                </motion.div>
                ...
                <motion.div
                  ...
                  transition={{ repeat: Infinity, duration: 6, ease: "linear" }}
                >
                  <FaUserGraduate className="bg-primary text-white dark:text-gray-900 rounded-xl h-8 w-8 sm:h-10 sm:w-10 p-2" />
                </motion.div>
                ...
                <motion.div
                  ...
                  transition={{ repeat: Infinity, duration: 6, ease: "linear" }}
                >
                  <FaPalette className="border-2 border-primary bg-transparent text-primary rounded-xl h-8 w-8 sm:h-10 sm:w-10 p-2" />
                </motion.div>
              </div>
            </motion.div>
          </div>
      ...
      <motion.div
        ...
        className="absolute top-3/4 left-1/2 transform -translate-x-1/2 flex flex-col items-center py-0"
      >
