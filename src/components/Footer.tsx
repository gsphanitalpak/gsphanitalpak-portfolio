...
export default function Footer() {
  ...
  return (
        ...
        <div className="flex  gap-10 justify-between">
          <div className="md:col-span-1">
            ...
            >
              {darkMode ? (
                <img
                  src="final_logo_white.svg"
                  alt="Santhosh Logo Dark"
                  className="h-20 w-auto"
                />
              ) : (
                <img
                  src="final_logo_black.svg"
                  alt="Santhosh Logo Light"
                  className="logo h-20 w-auto"
                />
              )}
            </Link>
            <p className="mt-4 text-gray-600 dark:text-gray-400">
              Crafting intelligent systems through applied AI, robotics, and
              research-driven engineering.
            </p>
            <div className="flex space-x-4 mt-6">
              {["GitHub", "LinkedIn", "Google Scholar", "Email"].map(
                (social) => {
                  let svgIcon;
                  let href;
    ...
    "
                      ...
                      href =
                        "www.linkedin.com/in/santhosh-phanitalpak-gandhala";
                      break;
                    case "Google Scholar":
                      svgIcon = (
                        <svg
  ...
  "
                      ...
                      href =
                        "https://scholar.google.com/citations?user=GZn0hCAAAAAJ&hl=en&oi=ao";
                      break;
                    case "Email":
                      svgIcon = (
                        <svg
                        ...
                        >
                          <path
                            ...
                            strokeLinejoin="round"
                            strokeWidth={2}
                            d="M3 6h18c1.1 0 1.99.9 1.99 2L21 18c0 1.1-.89 2-1.99 2H3c-1.1 0-1.99-.9-1.99-2L3 8c0-1.1.89-2 1.99-2z M3 6l9 6 9-6"
                          />
                        </svg>
                      );
                  ...
                  return (
                    ...
                    >
                      <a href={href} aria-label={social} className="block">
                        ...
                        <div className="p-2 rounded-full transition-transform duration-300 ease-in-out group-hover:scale-110 group-hover:rotate-3">
                          {svgIcon}
                        </div>
                      </a>
                    </Button>
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 mt-10 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-600 dark:text-gray-400 text-sm">
            © {currentYear} Santhosh Phanitalpak Gandhala. All rights reserved.
          </p>
