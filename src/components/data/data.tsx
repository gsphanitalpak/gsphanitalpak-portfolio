...
export const posts: PostType[] = [
  {
    id: 1,
    title: 'Building a Real-Time Object Detection System with TensorFlow.js',
    slug: 'real-time-object-detection-tensorflowjs',
    coverImage: '/images/blog/object-detection.jpg',
    publishedAt: '2025-03-10',
    category: 'AI',
    excerpt: 'Learn how to create a browser-based, real-time object detection app using TensorFlow.js and the COCO-SSD model. Perfect for adding interactive ML features to web projects.',
    tags: ['TensorFlow.js', 'Object Detection', 'Web ML'],
  },
  {
    id: 2,
    title: 'Designing Autonomous Navigation for Mobile Robots',
    slug: 'autonomous-navigation-mobile-robots',
    coverImage: '/images/blog/robot-navigation.jpg',
    publishedAt: '2025-02-22',
    category: 'Robotics',
    excerpt: 'In this post, we explore path-planning algorithms and sensor fusion strategies to enable reliable autonomous navigation in indoor mobile robots.',
    tags: ['ROS', 'Path Planning', 'SLAM'],
  },
  {
    id: 3,
    title: 'Serverless Microservices on AWS with Lambda and API Gateway',
    slug: 'serverless-microservices-aws-lambda',
    coverImage: '/images/blog/aws-serverless.jpg',
    publishedAt: '2025-01-05',
    category: 'Cloud Computing',
    excerpt: 'Step-by-step guide to building scalable serverless microservices using AWS Lambda, API Gateway, and DynamoDB, with CI/CD pipelines via CodePipeline.',
    tags: ['AWS Lambda', 'API Gateway', 'Serverless', 'CI/CD'],
  },
  {
    id: 4,
    title: 'A Beginner’s Guide to Blockchain Smart Contract Development',
    slug: 'beginner-guide-blockchain-smart-contracts',
    coverImage: '/images/blog/smart-contracts.jpg',
    publishedAt: '2024-12-18',
    category: 'Blockchain',
    excerpt: 'Covering Solidity basics, contract deployment, and security best practices, this guide helps you get started with Ethereum smart contract development.',
    tags: ['Solidity', 'Ethereum', 'Smart Contracts'],
  },
  {
    id: 5,
    title: 'Securing IoT Devices with Lightweight Encryption Protocols',
    slug: 'securing-iot-lightweight-encryption',
    coverImage: '/images/blog/iot-security.jpg',
    publishedAt: '2024-11-30',
    category: 'IoT',
    excerpt: 'Explore lightweight cryptographic methods tailored for resource-constrained IoT devices, and implement end-to-end secure communication.',
    tags: ['IoT Security', 'Encryption', 'Embedded Systems'],
  },
  {
    id: 6,
    title: 'Optimizing Machine Learning Models with Hyperparameter Tuning',
    slug: 'ml-hyperparameter-tuning',
    coverImage: '/images/blog/hyperparameter-tuning.jpg',
    publishedAt: '2025-04-15',
    category: 'AI',
    excerpt: 'Learn techniques like Grid Search, Random Search, and Bayesian Optimization to improve your model’s performance effectively.',
    tags: ['Machine Learning', 'Tuning', 'Model Optimization'],
  },
  {
    id: 7,
    title: 'How I Built a Dark Mode Notes App with AWS Free Tier',
    slug: 'dark-mode-notes-app-aws',
    coverImage: '/images/blog/dark-notes-app.jpg',
    publishedAt: '2025-04-20',
    category: 'Cloud Computing',
    excerpt: 'A walkthrough of building and deploying a theme-toggle notes app using Lambda, API Gateway, DynamoDB, and Terraform – all on AWS Free Tier.',
    tags: ['AWS', 'Lambda', 'Terraform', 'Theme Toggle'],
  },
  {
    id: 8,
    title: 'Integrating Voice Commands into Your React Projects',
    slug: 'react-voice-command-integration',
    coverImage: '/images/blog/voice-react.jpg',
    publishedAt: '2025-03-25',
    category: 'Web Development',
    excerpt: 'Voice recognition is the future – here’s how to use the Web Speech API to add intuitive voice interactions into your React applications.',
    tags: ['React', 'Voice Commands', 'Web API'],
  },
  {
    id: 9,
    title: 'From Zero to Conversational: 90-Day Japanese Study Plan',
    slug: '90-day-japanese-conversational-plan',
    coverImage: '/images/blog/japanese-study.jpg',
    publishedAt: '2025-03-02',
    category: 'Productivity',
    excerpt: 'A practical roadmap for beginners to reach conversational Japanese in 3 months – including daily listening, speaking, and grammar targets.',
    tags: ['Language Learning', 'JLPT', 'Japanese'],
  },
  {
    id: 10,
    title: 'Crafting a Portfolio that Talks: AI-Driven 3D Avatar Integration',
    slug: 'ai-3d-avatar-portfolio',
    coverImage: '/projects/notes-app.png',
    publishedAt: '2025-04-05',
    category: 'Web Development',
    excerpt: 'Learn how to add an interactive 3D avatar to your portfolio that changes based on the section being viewed — powered by AI & storytelling.',
    tags: ['AI Avatar', 'Three.js', 'Developer Portfolio'],
  },
];
